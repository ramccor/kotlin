...
class IrGenerationExtensionException(cause: Throwable, val extension: IrGenerationExtension) : RuntimeException(cause.message, cause)
...
fun IrPluginContext.applyIrGenerationExtensions(
    ...
    for (extension in irGenerationExtensions) {
        try {
            ...
            throw IrGenerationExtensionException(e, extension)
        }
    }
}
