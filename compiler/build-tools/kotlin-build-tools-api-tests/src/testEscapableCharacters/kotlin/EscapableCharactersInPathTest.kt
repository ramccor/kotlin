...
class EscapableCharactersInPathTest : BaseCompilationTest() {
    ...
    fun testInClasspath(kotlinToolchain: KotlinToolchain, executionPolicy: ExecutionPolicy) {
    ...
    fun testInModulePath(kotlinToolchain: KotlinToolchain, executionPolicy: ExecutionPolicy) {
        scenario(kotlinToolchain, executionPolicy) {
