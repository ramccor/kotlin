...
const val minus1 = 2UL.<!EVALUATED("0")!>minus(2UL)<!>
const val minus2 = 3UL.<!EVALUATED("1")!>minus(2UL)<!>
const val minus3 = 2UL.<!EVALUATED("0")!>minus(2u.toUByte())<!>
const val minus4 = 2UL.<!EVALUATED("0")!>minus(2u.toUShort())<!>
const val minus5 = 2UL.<!EVALUATED("0")!>minus(2u)<!>
