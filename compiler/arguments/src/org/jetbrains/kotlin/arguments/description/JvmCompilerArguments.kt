...
val actualJvmCompilerArguments by compilerArgumentsLevel(CompilerArgumentsLevelNames.jvmCompilerArguments) {
    ...
    compilerArgument {
        ...
        lifecycle(
            introducedVersion = KotlinReleaseVersion.v1_0_1,
            stabilizedVersion = KotlinReleaseVersion.v1_0_1,
        )
    }
...
The default value is 1.""".asReleaseDependent()
    ...
    compilerArgument {
        ...
        lifecycle(
            introducedVersion = KotlinReleaseVersion.v1_1_5,
        )
    }
...
default: legacy""".asReleaseDependent()
    ...
    compilerArgument {
        ...
        lifecycle(
            introducedVersion = KotlinReleaseVersion.v1_2_41,
        )
    }
