...
internal fun requestTerminationInternal(id: Int, processScheduledJobs: Boolean): Int {
    val future = theState.addJobToWorker(id, null, null, !processScheduledJobs)
    if (future == null) ThrowWorkerAlreadyTerminated()
    return future.id
}
...
@PublishedApi
@ObsoleteWorkersApi
internal fun consumeFutureInternal(id: Int): Any? = theState.consumeFuture(id)
