...
/**
 * **Important**: implementations must not to access the project structure such as VFS, PSI or project model.
 *
 * See [com.intellij.openapi.application.TransactionGuard] and [com.intellij.openapi.application.TransactionGuard.assertWriteSafeContext]
 * for more details.
 *
