...
public sealed class KaPropertySymbol : KaVariableSymbol(), KaTypeParameterOwnerSymbol {
     ...
     *
     * **Note**: this information may not be fully preserved for symbols from libraries.
     *
     * #### Library exceptions
     *
     * ```kotlin
     * val fieldInsideCustomBody: Int = 0 // the field is generated, but this information is not preserved
     *   get() = field
     *
     * val defaultGetterWithAnnotation: String = "Foo" // the field is generated, but this information is not preserved
     *   @Anno get
     * ```
     *
     ...
     *
     * **Note**: this information is not preserved for symbols from libraries.
     *
     * @see backingFieldSymbol
     */
